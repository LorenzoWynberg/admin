...
export enum AddressType { Saved = 'saved', Snapshot = 'snapshot' };
export enum Attributes { NAME = 'name', PHONE = 'phone', AVATAR = 'avatar', SEX_ID = 'sexId', LANG_CODE = 'langCode', EMAIL = 'email', PASSWORD = 'password', NEW_PASSWORD = 'newPassword', CURRENT_PASSWORD = 'currentPassword', PASSWORD_CONFIRMATION = 'passwordConfirmation', ADDITIONAL_INFO = 'additionalInfo', LABEL = 'label', LATITUDE = 'latitude', LONGITUDE = 'longitude', IS_PRIMARY = 'isPrimary', IS_PHYSICAL = 'isPhysical', OWNER_ID = 'ownerId', OWNER_TYPE = 'ownerType', CREATED_AT = 'createdAt', UPDATED_AT = 'updatedAt', DELETED_AT = 'deletedAt', DATE_OF_BIRTH = 'dateOfBirth', EMAIL_VERIFIED_AT = 'emailVerifiedAt', FROM_NAME = 'fromName', FROM_PHONE = 'fromPhone', FROM_ADDRESS = 'fromAddress', TO_NAME = 'toName', TO_PHONE = 'toPhone', TO_ADDRESS = 'toAddress', DESCRIPTION = 'description', CURRENCY = 'currency' };
export enum CrudAction { Retrieved = 'retrieved', Created = 'created', Updated = 'updated', Edited = 'edited', Deleted = 'deleted', Unchanged = 'unchanged', Restored = 'restored', ForceDeleted = 'force_deleted' };
